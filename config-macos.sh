...
# I highly recommend checking out the original source from Mathias:
# https://mths.be/macos

# Here's mine that has a few of my own personal preferences:
# https://github.com/s10wen/dotfiles/blob/master/.macos
...
# TODO: auotmate the change to Solarized Dark
# https://github.com/mbadolato/iTerm2-Color-Schemes/issues/140
...
# Install Sublime Text custom theme additions
# cp init/Monokai-Phoenix.tmTheme ~/Library/Application\ Support/Sublime\ Text\ 3/Packages/User/
...
# Update Icons
# cp -R icons/Sublime\ Text/. /Applications/Sublime\ Text.app/Contents/Resources/
...
# cp init/Shortcuts.json ~/Library/Application\ Support/Spectacle/

# TODO: Launch Spectacle on login
# TODO: Run Spectacle as background application to hide the icon in the menu bar
# https://github.com/eczarny/spectacle/issues/424#issuecomment-429779502
